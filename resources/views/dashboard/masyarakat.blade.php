        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="flex-1">
                    ...
                    <!-- WhatsApp Automatic Notification Alert Banner -->
                    <div x-data="{ showWaInfo: true }" x-show="showWaInfo" x-transition
                        class="mb-8 bg-gradient-to-br from-slate-900 via-slate-900 to-[#0c1f17] rounded-3xl p-6 sm:p-7 text-white shadow-xl shadow-slate-200/50 border border-emerald-500/30 relative overflow-hidden">
                        
                        <!-- Background Glow Decoration -->
                        <div class="absolute -right-10 -bottom-10 w-64 h-64 bg-emerald-500/10 rounded-full blur-3xl pointer-events-none"></div>
                        <div class="absolute top-0 right-0 p-4">
                            <button @click="showWaInfo = false" class="text-slate-400 hover:text-white p-1.5 rounded-xl hover:bg-white/10 transition-colors" title="Tutup">
                        ...
                        <div class="flex flex-col md:flex-row items-start md:items-center gap-5 relative z-10">
                            <!-- WhatsApp Icon Badge -->
                            <div class="w-14 h-14 rounded-2xl bg-emerald-500/20 border border-emerald-400/30 flex items-center justify-center flex-shrink-0 text-emerald-400 shadow-inner">
                            ...
                            <div class="flex-1 pr-6">
                                <div class="flex flex-wrap items-center gap-2 mb-1.5">
                                    <h3 class="text-base sm:text-lg font-bold text-white tracking-tight">Notifikasi WhatsApp Otomatis</h3>
                                ...
                                <p class="text-xs sm:text-sm text-slate-300 leading-relaxed mb-4">
                                    Status permohonan Anda akan diberitahukan secara otomatis langsung ke nomor WhatsApp yang terdaftar:
                                </p>
                                
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                                    <!-- Permohonan Selesai -->
                                    <div class="bg-white/[0.06] border border-white/10 rounded-2xl p-4 flex items-start gap-3 backdrop-blur-sm">
                                        ...
                                        <div>
                                            <h4 class="text-xs font-bold text-emerald-300 uppercase tracking-wider">Saat Permohonan Selesai</h4>
                                            <p class="text-[12px] text-slate-300 mt-1 leading-relaxed">
                                                Anda akan menerima pesan WhatsApp berisi konfirmasi nomor surat resmi dan panduan unduh/cetak dokumen.
                                            </p>
                                        </div>
                                    </div>

                                    <!-- Permohonan Ditolak / Perlu Perbaikan -->
                                    <div class="bg-white/[0.06] border border-white/10 rounded-2xl p-4 flex items-start gap-3 backdrop-blur-sm">
                                        <div class="w-8 h-8 rounded-xl bg-amber-500/20 text-amber-400 flex items-center justify-center flex-shrink-0 mt-0.5">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
                                        </div>
                                        <div>
                                            <h4 class="text-xs font-bold text-amber-300 uppercase tracking-wider">Saat Perlu Perbaikan / Ditolak</h4>
                                            <p class="text-[12px] text-slate-300 mt-1 leading-relaxed">
                                                Rincian data/berkas yang perlu diperbaiki beserta catatan verifikator akan langsung dikirim ke WhatsApp Anda.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div x-show="showForm" x-transition
                            ...
                            <div class="p-8">
                                ...
                                <form :action="isEdit ? '{{ url('masyarakat/permohonan') }}/' + editId : '{{ route('masyarakat.store') }}'" 
                                    ...
                                    <!-- Rejection Banner in Edit Form -->
                                    <template x-if="isEdit && selectedPermohonan && selectedPermohonan.status === 'ditolak'">
                                        <div class="mb-6 bg-red-50 border border-red-200 p-4 rounded-2xl flex items-start gap-3">
                                            <div class="bg-red-100 text-red-600 p-2 rounded-xl shrink-0">
                                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
                                            </div>
                                            <div>
                                                <h4 class="text-red-800 font-bold text-sm">Permohonan Perlu Diperbaiki</h4>
                                                <p class="text-red-600 text-xs mt-0.5" x-text="alasan ? 'Catatan Tambahan Petugas: ' + alasan : 'Silakan periksa dan perbaiki data atau berkas yang ditandai merah di bawah.'"></p>
                                            </div>
                                        </div>
                                    </template>
                                            ...
                                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-[11px] text-slate-500 mt-1 flex items-center gap-1">
                                                         <svg class="w-3.5 h-3.5 text-emerald-600 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                                                         Notifikasi saat permohonan selesai atau ditolak/perbaikan akan otomatis dikirimkan ke nomor ini.
                                                    </p>
                        ...
                        <div class="bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
                            <div class="p-6 border-b border-slate-100 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                                <div>
                                    ...
                                    <p class="text-xs text-slate-500 mt-0.5">Pantau progres dan status verifikasi permohonan surat Anda</p>
                                </div>
                                <div class="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-emerald-50 border border-emerald-100 text-xs font-semibold text-emerald-700 w-fit">
                                    <svg class="w-4 h-4 text-emerald-600 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/></svg>
                                    <span>Notifikasi WA Aktif (Selesai & Ditolak)</span>
                                </div>
                            </div>
                            ...
                            <div class="space-y-4">
                                ...
                                <template x-if="selectedPermohonan.status === 'ditolak'">
                                    <div class="bg-red-50 p-4 rounded-xl border border-red-200 space-y-3">
                                        ...
                                        <template x-if="parseItems(selectedPermohonan.invalid_items).length === 0">
                                            <div class="pl-11">
                                                <p class="text-xs text-red-600">Mohon periksa permohonan Anda kembali sesuai Catatan Tambahan Petugas di bawah.</p>
                                            </div>
                                        </template>
